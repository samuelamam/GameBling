  <div class="content-wrapper">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">登出将会清除您的登陆信息！</div>
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">取消</button>
            <a class="btn btn-primary" href="<?=base_url('admin/login/index')?>">登出</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <script src="/application/views/admin/vendor/chart.js/Chart.min.js"></script>
    ...
    <script src="/application/views/admin/js/sb-admin-charts.min.js"></script>
  </div>
</body>
